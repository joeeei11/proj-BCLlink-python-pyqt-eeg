...
本文件是进行中阶段的活动文档。请始终指向 `tasks/phase{N}_current.md` 中的最新 Phase。

> 当前指向：`tasks/backlog/phase_03.md` —— Phase 3：EEG 采集与传输层统一

开始新 Phase 时：
1. 把该 Phase 的 `phase{N}_current.md` 全文复制覆写到 `tasks/current.md`
2. 在 `tasks/progress.md` 更新"当前 Phase / 已完成 Phase / 下一个 Phase"
3. 如有技术取舍分歧，补写 `tasks/decisions.md` 的 ADR 条目

---

（以下内容同 `tasks/backlog/phase_03.md`，供快速查看）
